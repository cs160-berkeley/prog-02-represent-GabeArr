...
public class MoveDataProvider {
    private Drawable move_poster_resource;
    ...
    public MoveDataProvider(Drawable move_poster_resource,String move_title,String move_rating, String email, String tweet, String party){
    ...
    public Drawable getMove_poster_resource() {
        return move_poster_resource;
    }

    public void setMove_poster_resource(Drawable move_poster_resource) {
